...
def manufacsignup():
    return render_template('manufacturersignup.hmtl')
...
def register():
    ...
    if(password!=confirmPassword):
        if(role=="consumer"):
            return render_template("consumersignup.html",message='passwords not matched, try again')
        elif(role=="Manufacturer"):
            return render_template("manufacturersignup.html",message='passwords not matched, try again')
        elif(role=="retailer"):
            return render_template("retailersignup.html",message='passwords not matched, try again')
        else:
            return render_template("index.html")
